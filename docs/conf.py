...
# -*- coding: utf-8 -*-
#
# saramis documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under saramis
...
# The short X.Y version.
# version = saramis.__version__
# The full version, including alpha/beta/rc tags.
# release = saramis.__version__
...
latex_documents = [
    ('index', 'saramis.tex',
     u'SARAMIS Documentation',
     u'Nina Montana Brown', 'manual'),
]
